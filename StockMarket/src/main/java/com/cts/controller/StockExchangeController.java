...
public class StockExchangeController {
	...
	public StockExchange updateStockExchange(@RequestBody StockExchange stockexchange,@PathVariable("id") String id)
	{
	 ...
	 public StockExchange findoneinall(@PathVariable("id") String id)
	 {
	 Optional<StockExchange> stockexchange = stockexchangeRepository.findById(id);
